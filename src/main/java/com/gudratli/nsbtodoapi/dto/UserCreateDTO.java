...
@Data
@ApiModel(value = "User Create", description = "DTO used for creating new user account.")
public class UserCreateDTO
{
    ...
    @ApiModelProperty(value = "Password of user account", required = true)
    ...
    @ApiModelProperty(value = "ID of role of user.", example = "11", required = true)
